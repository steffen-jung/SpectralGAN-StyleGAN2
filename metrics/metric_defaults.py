...
metric_defaults = EasyDict([(args.name, args) for args in [
    EasyDict(name='sd50k',     class_name='metrics.spectral_distance.SD', max_reals=None, num_fakes=50000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
